...
#[derive(Debug)]
pub struct HotWalletProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HotWalletProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HotWallet processing");
    
    let mut processor = HotWalletProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HotWalletProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HotWalletProcessor::new(false);
